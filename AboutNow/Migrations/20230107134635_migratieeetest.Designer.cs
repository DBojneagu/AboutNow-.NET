...
namespace AboutNow.Migrations
{
    ...
    [Migration("20230107134635_migratieeetest")]
    partial class migratieeetest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AboutNow.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AboutNow.Models.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AboutNow.Models.Comment", b =>
                {
                    b.HasOne("AboutNow.Models.Journal", "Journal")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("AboutNow.Models.GroupMessage", b =>
                {
                    ...
                    b.HasOne("AboutNow.Models.Profile", "Profile")
                        .WithMany()
                        .HasForeignKey("ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
